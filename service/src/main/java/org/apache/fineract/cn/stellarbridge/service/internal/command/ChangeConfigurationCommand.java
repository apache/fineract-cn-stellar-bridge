...
public class ChangeConfigurationCommand {

  private final String tenantIdentifier;
  private final BridgeConfiguration instance;

  public ChangeConfigurationCommand(
      final String tenantIdentifier,
      final BridgeConfiguration instance) {
  ...
  public BridgeConfiguration instance() {
